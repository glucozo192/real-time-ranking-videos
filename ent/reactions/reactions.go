...
const (
	// Label holds the string label denoting the reactions type in the database.
	Label = "reactions"
	...
	// Table holds the table name of the reactions in the database.
	Table = "tbl_reactions"
	// TblVideosTable is the table that holds the tbl_videos relation/edge.
	TblVideosTable = "tbl_reactions"
...
// Columns holds all SQL columns for reactions fields.
var Columns = []string{
	FieldID,
	FieldVideoID,
	FieldDescription,
...
// OrderOption defines the ordering options for the Reactions queries.
